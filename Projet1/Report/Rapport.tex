...
\title{Projet 2 - Programmation sur machine nue - Système informatique 2} % Defines the thesis title - don't touch this
%-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
\textsc{\Large Project 1 : Discovery of Comet}\\[0.5cm] % Thesis type
...
\lstinputlisting[language=C]{facts.co}
...
\lstinputlisting[language=C]{constraints.co}
